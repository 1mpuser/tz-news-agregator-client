<!-- style="background-color: url(url)" -->
<template>
	<div class="blog-card">
		<div class="meta">
			<div
				class="photo"
				style="background-color : url({{this.newsItem.img}})"
			></div>
			<ul class="details">
				<a href="#">{{ newsItem.author }}</a>
				<li class="date">{{ newsItem.dateOfCreate }}</li>
			</ul>
		</div>
		<div class="description">
			...
			<p class="read-more">
				<a href="#" @click="$router.push(`/${this.index}`)">Read More</a>
			</p>
		</div>
	</div>
</template>
